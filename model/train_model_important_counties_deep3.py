...
if __name__ == "__main__":
    ...
    config = Config()
    RUN_NAME = "important_counties" #DoNtN'T FORGET TO CHANGE THIS!!!
    config.save_path = os.path.expanduser('~/cs231n-satellite-images-models/runs/run8__deeper3__soybean/' + RUN_NAME)
