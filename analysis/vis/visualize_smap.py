...
def graph_vis():
    ...
    axarr[0].imshow(all_vis_soy_n, cmap='gray')
    ...
    axarr[1].imshow(all_vis_corn_n, cmap='gray')
    #axarr[1].axis([START_BAND, END_BAND + 1, START_TIME, END_TIME + 1])
